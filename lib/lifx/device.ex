defmodule Lifx.Device do
  ...
  def handle_cast(
        {:packet, %Packet{:protocol_header => %ProtocolHeader{:type => @statelabel}} = packet},
        state
      ) do
  ...
  def handle_cast(
        {:packet, %Packet{:protocol_header => %ProtocolHeader{:type => @statepower}} = packet},
        state
      ) do
  ...
  def handle_cast(
        {:packet, %Packet{:protocol_header => %ProtocolHeader{:type => @stategroup}} = packet},
        state
      ) do
  ...
  def handle_cast(
        {:packet, %Packet{:protocol_header => %ProtocolHeader{:type => @statelocation}} = packet},
        state
      ) do
  ...
  def handle_cast(
        {:packet, %Packet{:protocol_header => %ProtocolHeader{:type => @light_state}} = packet},
        state
      ) do
    s = %State{
      state
  ...
  def handle_cast(
        {:packet, %Packet{:protocol_header => %ProtocolHeader{:type => @statewifiinfo}} = packet},
        state
      ) do
    s = %State{
      state
